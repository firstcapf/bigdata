     ...
     <div class="yjiu_hz">
        <div id="demo-nested" class="cwBox boxHz">
          <ul id="demo-nested-nav">
            <li><a href="#">智慧林业大数据综合管理平台</a></li>
         </ul>
         <div class="tabs-container">
            <div class="tab-nested ctbox">

				 <div class="textbox">
<p align="left">&nbsp; &nbsp; &nbsp;&nbsp;项目建设目标：建设智慧林业大数据综合管理平台，实现林业数据采集、数据汇交、数据处理、预警分析、查询共享、林业数据专题服务等功能。<br>
项目建设规模：总体项目在林业厅建设一套智慧林业大数据综合管理平台。包括林业数据智慧采集系统、数据库管理系统、平台接入系统、平台工具软件、林业资源数据共享平台、大数据支撑平台、林业环境与灾害分析预警系统、林业资源专题服务平台、平台运维管理系统共九大系统。
<img src="img/zhly-1.png">
<br>
主要任务是推动“智慧林业”建设，构筑新一代林业信息技术体系；建立完善林业大数据体系，推进林业管理决策的科学化、智能化；建设覆盖林业信息管理基础平台，全面落实林业信息登记制度；深化和拓展林业综合监管平台应用，建立精准治理、多方参与的林业监管新模式；推进林业信息数据共享与开放，充分发挥林业信息在实施国家大数据战略中的重要基础作用；构建“互联网+林业政务服务”体系，有效提升林业惠民服务水平；完善地质环境与地质灾害预警预报体系，整体提升地质灾害防御与应急能力；深入推进林业调查评价信息化，全面快速掌握林业资源资产开发利用状况；大力推动林业调查工作信息化建设，全面提高林地调查工作的现代化水平和社会服务能力；建立和完善信息化标准体系，形成规范、有序的信息化建设新局面；加强林业信息安全保障体系建设，切实提升网络安全防护能力。
</p>
