    ...
    <div class="top">
        ...
        <div class="rtop">
            ...
            <ul id="nav" style="width: 740px;">
                ...
                <li id="navactive" class="navitem"><a href="yjfx1.html">研究方向</a></li>
...
<div id="mbaoxue">
    <div id="page_content">
        您所在的位置 > <a href="../index.html">首页</a> > <span>研究方向 </span>
    </div>
</div>
<div id="page_content">
    <!--左侧栏目-->
        ...
        <div id="demo-nested" class="cwBox boxHz">
            ...
            <div class="tabs-container">
                ...
                <div class="tab-nested">
                    ...
                    <div class="textbox">
                        <p align="left">&nbsp; &nbsp; &nbsp;&nbsp;地理信息系统</p>
                    </div>
                    <h4 class="yjbt_fl">&nbsp; &nbsp; &nbsp; &nbsp;项目简介</h4>
                    <div class="textbox">
                        <p align="left">&nbsp; &nbsp; &nbsp; &nbsp;针对动态三维数字地表建模与分析这一国际学术前沿问题和国家重大需求，以该领域中的地上下室内外三维立体空间和地物目标实体及其相互关系的抽象与表达为主线，研究了三维数字地表建模与分析和动态三维GIS与虚拟地理环境等基本问题。广泛应用于全息位置地图、传感器实时接入GIS、视频-状态与行为感知监控系统、空气模拟图、BIM与GIS的集成、三维GIS、水模拟图、倾斜摄影测量-航空倾斜影像处理等方面。
                        </p>
                    </div>

                    <h4 class="yjbt_fl"><img src="../static/images/yj_3sf.jpg" />示范项目2</h4>
                    <div class="textbox">
                        <p align="left">&nbsp; &nbsp; &nbsp;&nbsp;倾斜摄影测量交互式建模软件</p>
                    </div>
                    <h4 class="yjbt_fl">&nbsp; &nbsp; &nbsp; &nbsp;项目简介</h4>
                    <div class="textbox">
                        <p align="left">&nbsp; &nbsp; &nbsp; &nbsp; 利用现有倾斜摄影测量产品，如三角网，DSM/DOM等，通过二维影像与三维三角网一起交互式勾绘方式，提高建模效率，降低三维建模软件专业要求；现有倾斜摄影测量方法已可以较高的自动化程度生成无拓扑、语义信息的三角网模型，并在此基础上获取表达连续地表的DSM/DOM等LOD0级三维模型，然而LOD0级模型仅为可视化模型，只具备简单的三维量测能力，急需从倾斜影像到单体化矢量模型生产的工艺流程，满足智慧城市建设的方方面面的智能应用。
                        </p>
                    </div>

                    <h4 class="yjbt_fl"><img src="../static/images/yj_3sf.jpg" />示范项目3</h4>
                    <div class="textbox">
                        <p align="left">&nbsp; &nbsp; &nbsp;&nbsp;RGB-D高精度室内三维重建</p>
                    </div>
                    <h4 class="yjbt_fl">&nbsp; &nbsp; &nbsp; &nbsp;项目简介</h4>
                    <div class="textbox">
                        <p align="left">&nbsp; &nbsp; &nbsp; &nbsp; 新兴的RGB-D传感器通过价格低廉，实时，以及可接受的量测精度打入室内建模市场， 其深度相机主要是以结构光原理进行成像，通常具有激光投射器、光学衍射元件（DOE）、红外摄像头三大核心器件。它可以同时产生RGB图像和深度图像，如下图所示，工作机制和视频流类似，以每秒30帧的速度收集数据。下图中是Primer sense 的strucutre sensor相机，它的doe是由两部分组成的，一个是扩散片，一个是衍射片。先通过扩散成一个区域的随机散斑，然后复制成九份，投射到了被摄物体上。根据红外摄像头捕捉到的红外散斑，PS1080这个芯片就可以快速解算出各个点的深度信息。
                        </p>
                    </div>
                </div>
                <div class="tab-nested">
