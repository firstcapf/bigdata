...
<div id="page_content">
    <p>中心基于自然资源云计算与大数据基础理论及关键技术开展基础研究；围绕自然资源调查的数据采集、数据理解和数据应用过程，开展自然资源环境空天地一体化智能感知与综合监控、自然资源遥感影像大数据智能理解、自然资源环境灾害预警与自动响应处置技术研究；将研究成果服务于自然资料调查需求，开展自然资源调查与监测监管技术的应用研究；建立自然资源大数据安全保障体系和分析评价体系，从自然资源调查的“数据采集->数据理解->数据应用”三个实施阶段，经过“基础研究->技术研究->应用研究”三个研究层次，实现“技术创新->工程研发->成果转化”三步创新路径，最终实现自然资源调查与监测监管的应用示范目标。</p>
    <img src="../../static/static/images/dir.jpg" alt=""/>
    <!--左侧栏目-->
    <#--<div class="left_box" id="spleft">-->
        ...
        <#--<div id="lanmu_list">-->
            <#--<ul>-->
                ...
                <#--<li id="cbnavactive"><a href="#" title="方向5：自然资源调查与监测监管技术">方向5：自然资源调查与监测监管技术</a></li>-->
        ...
        <#--<div id="demo-nested" class="cwBox boxHz">-->
            ...
            <#--<div class="tabs-container">-->
                <#--<div class="tab-nested ctbox">-->
                    <#--<h4 class="yjbt_fl"><img src="../static/images/yj_1gs.jpg" />自然资源调查与监测监管技术 </h4>-->
                    <#--<div class="textbox">-->
                        <#--<p align="left">&nbsp; &nbsp; &nbsp;&nbsp;研究当前自然资源的调查现状和技术，研究自然资源调查的理论基础、方法、方案、标准和技术路线。采用遥感技术进行宏观影像数据采集，多种途径完成要素数调查，研究山水林田湖草自然资源的特点，分析不同资源类型的调查难点。</p>-->
                        <#--<p align="left">&nbsp; &nbsp; &nbsp;1) 基于多源异构的自然资源大数据的超融合技术</p>-->
                        <#--<p align="left">&nbsp; &nbsp; &nbsp;2) 基于复杂地形多环境自然资源大数据采集模式和技术</p>-->
                        <#--<p align="left">&nbsp; &nbsp; &nbsp;3) 基于大数据平台的多维数据的质检平台架构</p>-->
                        <#--<p align="left">&nbsp; &nbsp; &nbsp;4) 自然资源综合检测评估模型</p>-->
                        <#--<p align="left">&nbsp; &nbsp; &nbsp;5) 自然资源多维数据可视化展示技术</p>-->
                    <#--</div>-->
                <#--</div>-->
                <#--<div class="tab-nested">-->
                    ...
                    <#--<div class="textbox">-->
                        <#--<p align="left">&nbsp; &nbsp; &nbsp; &nbsp;智慧数采系统将原始数据采集，经无线网络实时传递到数据中心的云端，经大数据处理中心分析，实现精准一对一扶贫。</p>-->
                    <#--</div>-->
                <#--</div>-->
                <#--<div class="tab-nested">-->
                    <#--<p>正在建设中，敬请期待！</p>-->
                    <#--&lt;#&ndash;<ul class="media">&ndash;&gt;-->
                        <#--&lt;#&ndash;<li>&ndash;&gt;-->
                            <#--&lt;#&ndash;<!--&ndash;&gt;-->
                              <#--&lt;#&ndash;<embed src="http://player.youku.com/player.php/sid/XMzE3OTY4MzMy/v.swf"&ndash;&gt;-->
                              <#--&lt;#&ndash;allowFullScreen="true" quality="high" width="420" height="205" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash">&ndash;&gt;-->
                            <#--&lt;#&ndash;</embed>&ndash;&gt;-->
                           <#--&lt;#&ndash;&ndash;&gt;&ndash;&gt;-->
                            <#--&lt;#&ndash;<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="610" height="300">&ndash;&gt;-->
                                <#--&lt;#&ndash;<param name="movie" value="http://player.youku.com/player.php/sid/XMzE3OTY4MzMy/v.swf" />&ndash;&gt;-->
                                <#--&lt;#&ndash;<param name="quality" value="high" />&ndash;&gt;-->
                                <#--&lt;#&ndash;<param name="wmode" value="transparent" />&ndash;&gt;-->
                                <#--&lt;#&ndash;<embed src="http://player.youku.com/player.php/sid/XMzE3OTY4MzMy/v.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="610" height="300"></embed>&ndash;&gt;-->
                            <#--&lt;#&ndash;</object>&ndash;&gt;-->
                        <#--&lt;#&ndash;</li>&ndash;&gt;-->
                        <#--&lt;#&ndash;<li>&ndash;&gt;-->
                            <#--&lt;#&ndash;<!--&ndash;&gt;-->
                              <#--&lt;#&ndash;<embed src="http://player.youku.com/player.php/sid/XNDQ1MTkyODI4/v.swf"&ndash;&gt;-->
                              <#--&lt;#&ndash;allowFullScreen="true" quality="high" width="420" height="205" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash">&ndash;&gt;-->
                            <#--&lt;#&ndash;</embed>&ndash;&gt;-->
                           <#--&lt;#&ndash;&ndash;&gt;&ndash;&gt;-->
                            <#--&lt;#&ndash;<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="610" height="300">&ndash;&gt;-->
                                <#--&lt;#&ndash;<param name="movie" value="http://player.youku.com/player.php/sid/XNDQ1MTkyODI4/v.swf" />&ndash;&gt;-->
                                <#--&lt;#&ndash;<param name="quality" value="high" />&ndash;&gt;-->
                                <#--&lt;#&ndash;<param name="wmode" value="transparent" />&ndash;&gt;-->
                                <#--&lt;#&ndash;<embed src="http://player.youku.com/player.php/sid/XNDQ1MTkyODI4/v.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="610" height="300"></embed>&ndash;&gt;-->
                            <#--&lt;#&ndash;</object>&ndash;&gt;-->
                        <#--&lt;#&ndash;</li>&ndash;&gt;-->
                    <#--&lt;#&ndash;</ul>&ndash;&gt;-->
                <#--</div>-->
