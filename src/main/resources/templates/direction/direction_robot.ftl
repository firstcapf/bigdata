        ...
        <div id="demo-nested" class="cwBox boxHz">
            ...
            <div class="tabs-container">
                ...
                <div class="tab-nested">
                    ...
                    <div class="textbox">
                        <p align="left">&nbsp; &nbsp; &nbsp;&nbsp;多智能体系统协调控制与多机器人协作技术</p>
                    </div>
                    <h4 class="yjbt_fl">&nbsp; &nbsp; &nbsp; &nbsp;项目简介</h4>
                    <div class="textbox">
                        <p align="left">&nbsp; &nbsp; &nbsp; &nbsp;多智能体系统协调控制是控制领域当今最热门的方向之一，主要应用于：安全监控、灾后搜救、移动操作、目标围捕。
                        </p>
                    </div>

                    <h4 class="yjbt_fl"><img src="../static/images/yj_3sf.jpg" />示范项目2</h4>
                    <div class="textbox">
                        <p align="left">&nbsp; &nbsp; &nbsp;&nbsp;移动机器人</p>
                    </div>
                    <h4 class="yjbt_fl">&nbsp; &nbsp; &nbsp; &nbsp;项目简介</h4>
                    <div class="textbox">
                        <p align="left">&nbsp; &nbsp; &nbsp; &nbsp;自主研发的旋翼飞行器，实现位置与姿态的稳定，具有自定位和巡航能力的无人自主飞行器，可以抵抗强烈的外部干扰。
                        </p>
                    ...
                    <div class="textbox">
                        <p align="left">&nbsp; &nbsp; &nbsp;&nbsp;高精度运动控制、多机器人系统、智能机器人</p>
                    </div>
                    <h4 class="yjbt_fl">&nbsp; &nbsp; &nbsp; &nbsp;项目简介</h4>
                    <div class="textbox">
                        <p align="left">&nbsp; &nbsp; &nbsp; &nbsp;高精度运动控制系统的关键技术涉及：运动控制、伺服控制、机械结构设计及材料选择、装配工艺以及系统的保护等诸多方面的技术。
                        </p>
                        <p align="left">&nbsp; &nbsp; &nbsp; &nbsp;介绍几种典型的多机器人系统特点、以及多机器人之间相互协作工作、编队控制以及协作多机器人的系统模块化等。
                        </p>
                        &nbsp; &nbsp; &nbsp; 它有相当发达的“大脑”，局部形形色色的内部信息传感器和外部信息传感器，如视觉、听觉、触觉、嗅觉。它相当于一个独立的个体。
                    </div>

                    <h4 class="yjbt_fl"><img src="../static/images/yj_3sf.jpg" />示范项目4</h4>
                    <div class="textbox">
                        <p align="left">&nbsp; &nbsp; &nbsp;&nbsp;自主机器人研究</p>
                    </div>
                    <h4 class="yjbt_fl">&nbsp; &nbsp; &nbsp; &nbsp;项目简介</h4>
                    <div class="textbox">
