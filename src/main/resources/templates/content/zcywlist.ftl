...
<!--切换图代码-->
 ...
 <div id="banner">
    <div id="nyshow">
      <div class="jdtu"><img src="../static/images/zhengce_show.png" alt="政策要闻" /></div>
    </div>
     ...
     <div class="rtop">
       ...
       <ul id="nav" style="width: 740px;">
          <li id="moved"></li>
           ...
           <li id="navactive" class="navitem"><a href="newslist.ftl">动态消息</a></li>
  ...
  <div class="left_box" id="spleft">
    ...
    <form  id="navPage" action="/wrisc/newszhqy" method="post">
          <div class="pages">
                ...
                <a href="javascript:jumpPage(182)">尾页</a>
          </div>
