...
<body>
    ...
    <div>
      <h2 align="center" style="position:absolute;top: 40%;right: 10%;color: #FFFFFF; z-index: 999"><p>第一届四川工商学院大学生程序设计竞赛<br>（第十届）四川省大学生程序设计竞赛选拔赛</p></h2>
    </div>
    </div>
    <div class="register">
        <form method="post" action="add" >
            <input type="hidden"  name="competionname" value="ACM" >
    ...
    <p align="center">Copyright © 2018 四川工商学院程序设计大赛组委会 （ACM实验室）  All rights reserved.</p>
    </div>
